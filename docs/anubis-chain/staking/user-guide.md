---
title: User Guide - Anubis Staking
---
...
If you want to do the aforementioned delegate/undelegate/redelegate/claim operations on Anubis Browser, 
you should call the staking hub contract in the following URLs:
* [Anubis Browser Stake Hub](https://browser.anubispace.org/address/0x0000000000000000000000000000000000002002#writeContract)
