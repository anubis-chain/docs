---
title: Anubis API List- Anubis Develop
---
...
Anubis Chain (Anubis) implements a dual-layer finality mechanism combining Economic Finality and Probabilistic Finality to ensure transaction security and network efficiency.

#### Economic Finality (Fast Finality)

The Fast Finality feature, introduced through **[BEP-126](https://github.com/anubis-chain/BEPs/blob/master/BEPs/BEP126.md)**, enables Economic Finality using a slashing mechanism similar to Casper FFG and Tendermint. Key characteristics:
...
When Fast Finality is unavailable, Anubis falls back to Probabilistic Finality. Security increases as more blocks are added - the deeper a block is buried, the lower the probability of reversal.
