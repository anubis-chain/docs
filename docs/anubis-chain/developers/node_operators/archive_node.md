---
title: Archive Node - Anubis Develop
---


# How to Run an Archive Node on Anubis Chain
...
## How to run an archive node for Anubis mainnet?

### Run with an Erigon client

[Erigon](https://github.com/node-real/bsc-erigon) now supports the Anubis mainnet. The latest version allows you to sync an archive node from scratch in just 3 days, using 4.3 TB of disk space. You can use Erigon to operate an archive node as shown below.

---
title: Anubis Erigon Node Deployment Guide
---

### Anubis Erigon Node Deployment

Anubis Erigon, maintained by the Node Real team, is a fork of Erigon aimed at becoming the premier archive node implementation for the Anubis network.

## Hardware Requirements

To ensure optimal performance of your Anubis Erigon node, we recommend the following hardware specifications:
...
## Anubis Erigon Node Deployment Steps
...
By following these steps, you can flexibly deploy either a full Anubis Erigon node or a fast node based on your requirements. Whichever option you choose, Anubis Erigon will provide you with an efficient and reliable node service.
