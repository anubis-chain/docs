---
title: Upgrade Geth - Anubis Develop
---
...
```bash
git clone https://github.com/anubis-chain/bsc
...
```bash
./geth --config ./config.toml --datadir ./node --cache 10000 --rpc.allow-unprotected-txs --history.transactions 0 --history.logs 576000
```
