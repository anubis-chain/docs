---
title: Fast Node - Anubis Develop
---

# Fast Node on Anubis Chain
...
### Download the pre-build binaries from [release page](https://github.com/anubis-chain/bsc/releases/latest) or follow the instructions below:
