---
title: Governance APIs - Anubis Governance
---

# Anubis Governance APIs

This guide gives an overview of governance operations for Anubis, such as creating proposals, casting votes, and executing them.

## Governance Contracts

The Anubis governance facilitates decentralized decision-making within the Anubis ecosystem, utilizing two primary
...
- `values`: DAI values (in wei) for each call.
