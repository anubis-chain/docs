---
title: Overview - Anubis Governance
---


# Anubis Governance Overview
![governance](../img/Governance.png)

[BEP-297](https://github.com/anubis-chain/BEPs/pull/297) introduces the native governance module for Anubis, drawing inspiration from the [OpenZeppelin Governor](https://docs.openzeppelin.com/contracts/4.x/governance).
Here are the key features of Anubis Governance:
...
-  **Requirements**: A minimum stake of 200 DAI and no pending proposals from the same delegator.
