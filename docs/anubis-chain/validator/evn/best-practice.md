---
title: EVN Best Practices - Anubis EVN
---
## Network Requirements
At the network layer, Anubis requires minimal latency to maximize time available for critical operations like block packaging and verification. The Anubis network maintains decentralization through validators distributed across diverse geographic locations worldwide.
