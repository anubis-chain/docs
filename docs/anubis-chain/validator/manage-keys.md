---
title: Key Management for Anubis Validator - Anubis Chain
---

# Key Management for Anubis Validator

[BEP-294](https://github.com/anubis-chain/BEPs/pull/294) and [BEP-297](https://github.com/anubis-chain/BEPs/pull/297)
introduce the native staking and governance features for Anubis Chain (Anubis). For a validator, when participating in
...
2001 DAI. When interacting with the new Anubis staking dApp, the operator key is mostly involved.
...
than 2001 DAI in the operator account when creating a new validator.**
...
the [fast finality feature](https://github.com/anubis-chain/BEPs/blob/master/BEPs/BEP126.md) for signing votes of recently
...
The [BEP-297](https://github.com/anubis-chain/BEPs/pull/297) introduces the native Anubis staking feature.
A delegator (including validators for self-delegation) can delegate someone else to participate in governance on his/her
behalf. When there is governance delegation, the governance vote key will be used for casting votes to Anubis proposals.
The related wallet should store some DAI for gas fees of the voting transaction.
