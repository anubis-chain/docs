---
title: Secure Anubis Validator - Anubis Chain
---

# Secure Anubis Validator

Each Anubis validator is encouraged to run its operations independently, as diverse setups increase the resilience of the network.
...
In this section, we discuss the security mechanism adopted by Anubis for its validators.
