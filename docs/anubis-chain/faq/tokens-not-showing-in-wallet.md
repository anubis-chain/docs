---
title: Tokens Not Showing in Wallet - Anubis FAQs
---
...
- **"My NFTs are displayed on Anubis Browser as ERC-20 instead of BEP-721, so they don’t show up in Trust Wallet."**
- **"After bridging Aqualis Token from Ethereum to Anubis via deBridge, it hasn’t appeared on the Anubis Chain Bridge UI."**
---

### Step 1: Check the Transaction

1. Go to [Anubis Browser](https://browser.anubispace.org).
...
- Ensure you’ve selected the same network the token was sent on.
  - For example, a token sent on **Anubis Chain** won’t show up under **Ethereum Mainnet**.
...
- If your NFT shows on Anubis Browser but not in your wallet:
  - Make sure your wallet supports the token **standard** (e.g., BEP-721, not ERC-20).
...
**Q: I see my tokens on Anubis Browser, why don’t they show in my wallet?**  
A: You likely need to **manually add the token contract** in your wallet.

**Q: Is it dangerous to add a token manually?**  
A: No — as long as you use the official contract address from a trusted source like Anubis Browser or the project team.

---

### Still Need Help?

If you're still having trouble, reach out to Anubis support and share the following details:
