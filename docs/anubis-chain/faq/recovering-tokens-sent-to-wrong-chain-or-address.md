---
title: Recovering Tokens Sent to the Wrong Chain or Address - Anubis FAQs
---
...
#### A. Sent Tokens to the Wrong Chain

1. Open your wallet app (e.g. Trust Wallet).
2. Switch to the **network where the tokens were mistakenly sent**.
...
3. Switch to the correct network (e.g., Anubis Chain).
...
1. Visit a blockchain explorer like [Anubis Browser](https://browser.anubispace.org).
...
If you’re still stuck, please reach out to Anubis support and include the following:
